...
- [x] 게시글 등록을 하면 http://localhost:8080/article/create 로 POST 요청을 보내어 DB에 해당 내용을 저장한다.
...
# 2차 요구사항
- [x] 게시글 상세페이지(http://localhost:8080/article/detail/{id}) 에 수정 버튼이 있다. 수정 버튼을 누르면 게시글을 수정 할 수 있는 폼이나 오고 수정이 가능하다.
